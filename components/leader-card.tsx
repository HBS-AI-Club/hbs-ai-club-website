...
export function LeaderCard({ leader }: { leader: Leader }) {
  return (
    <article className="flex flex-col items-center rounded-2xl border border-line bg-paper p-6 text-center transition-shadow hover:shadow-[0_2px_20px_rgba(26,23,20,0.06)]">
